...
namespace RocketMQ.Client
{
    public class TopicValidator
    {
        ...
        private static readonly HashSet<string> SYSTEM_TOPIC_SET = new HashSet<string>();

        /**
         * Topics'set which client can not send msg!
         */
        private static readonly HashSet<string> NOT_ALLOWED_SEND_TOPIC_SET = new HashSet<string>();
        ...
        public static bool isSystemTopic(String topic, RemotingCommand response)
        {
        ...
        public static bool isNotAllowedSendTopic(String topic)
        {
            return NOT_ALLOWED_SEND_TOPIC_SET.Contains(topic);
        }

        public static bool isNotAllowedSendTopic(String topic, RemotingCommand response)
        {
        ...
        public static HashSet<String> getSystemTopicSet()
        {
            return SYSTEM_TOPIC_SET;
        }

        public static HashSet<String> getNotAllowedSendTopicSet()
        {
